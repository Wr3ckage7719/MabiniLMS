          ...
          <div className="rounded-2xl border border-white/20 bg-background/90 p-6 lg:p-8 space-y-6 shadow-2xl backdrop-blur-md">{/* Header */}
            ...
            <div
              className={`overflow-hidden transition-[max-height,opacity] duration-300 ease-out ${
                isTeacher ? 'max-h-0 opacity-0' : 'max-h-40 opacity-100'
              }`}
              aria-hidden={isTeacher}
            >
            ...
            {isTeacher && (
              <p className="text-xs text-muted-foreground text-center -mt-1 transition-opacity duration-300">
