...
export function TeacherClassStream({
  ...
  // suppress unused-var lint for formatDateTime (defined to match original module shape)
  void formatDateTime;
        ...
        <div className="lg:col-span-3 space-y-4 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          {activeTab === 'stream' && (
            <StreamTab
              ...
              deletingAnnouncementIds={deletingAnnouncementIds}
              handleDeleteAnnouncement={handleDeleteAnnouncement}
              openEditAnnouncementDialog={openEditAnnouncementDialog}
              handleTogglePinAnnouncement={handleTogglePinAnnouncement}
              setSelectedAnnouncementForComments={setSelectedAnnouncementForComments}
              discussionPosts={discussionPosts}
              discussionPostsLoading={discussionPostsLoading}
              likingDiscussionPostIds={likingDiscussionPostIds}
              handleToggleDiscussionPostLike={handleToggleDiscussionPostLike}
              hidingDiscussionPostIds={hidingDiscussionPostIds}
              handleHideDiscussionPost={handleHideDiscussionPost}
              deletingDiscussionPostIds={deletingDiscussionPostIds}
              handleDeleteDiscussionPost={handleDeleteDiscussionPost}
            />
          )}
          ...
          {activeTab === 'submissions' && (
            <SubmissionsTab
              ...
              setShowSubmissionDetail={setShowSubmissionDetail}
              selectedSubmission={selectedSubmission}
              setSelectedSubmission={setSelectedSubmission}
              submissionGrade={submissionGrade}
              setSubmissionGrade={setSubmissionGrade}
